...
public class TutoPage1Fragment extends Fragment {
        ...
        public static TutoPage1Fragment newInstance(int backgroundColor, int page) {
            TutoPage1Fragment frag = new TutoPage1Fragment();
            Bundle b = new Bundle();
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
            ...
            switch (mPage) {
                case 0:
                    layoutResId = R.layout.fragment_tutorial_page1;
                    break;
                default:
                    layoutResId = R.layout.fragment_tutorial_page2;
            }
