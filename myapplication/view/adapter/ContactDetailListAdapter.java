...
public class ContactDetailListAdapter extends RecyclerView.Adapter<ContactDetailListAdapter.TimeLineDetailsAdapterViewHolder>{
    ...
    public ContactDetailListAdapter(@NonNull Context context, ArrayList<IContact> contactList, RequestManager glide) {
        LoggerHelper.info(ContactDetailListAdapter.class.toString(),"IN TimeLineDetailListAdapter");
    ...
    protected class TimeLineDetailsAdapterViewHolder extends RecyclerView.ViewHolder {
        ...
        public void load(IContact contact){
            ...
            List<VibrationMessage> messageList = contact.getMessageList();
            ...
            if(!messageList.isEmpty()){
                ...
                if(cpt_message > 0 ){
                    VibrationMessage message = messageList.get(messageList.size() - 1);
                    if(message != null){
